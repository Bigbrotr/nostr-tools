...
async def fetch_nip11(client: Client):
    ...
    Returns:
        dict or None: Dictionary containing NIP-11 metadata or None if not available
    """
...
async def check_connectivity(client: Client):
    ...
    Returns:
        tuple: (rtt_open in ms or None, openable as bool)
...
async def check_readability(client: Client):
    ...
    Returns:
        tuple: (rtt_read in ms or None, readable as bool)
...
async def check_writability(
    ...
    Returns:
        tuple: (rtt_write in ms or None, writable as bool)
...
async def fetch_connection(
    ...
    Returns:
        dict or None: Dictionary containing connection metrics with keys:
